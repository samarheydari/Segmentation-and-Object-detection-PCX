...
from datasets.flood import flood_train, flood_test
from datasets.person_car import person_car_train, person_car_test
...
DATASETS = {
    ...
    "person_car":
    {"train": person_car_train,
    "test": person_car_test,
    "n_classes": 2,
    },
