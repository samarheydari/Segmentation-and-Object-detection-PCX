...
def get_yolov6(*args, **kwargs):
    _ensure_yolov6_on_path()
    cfg = Config({"model": MODEL_yolov6s})
    model = build_model(cfg=cfg, num_classes=80, device=0)
    sd = torch.load("/home/heydari/paper/12-supp/code/models/yolob6s_ckpt.pt")
...
def get_yolov6s6(*args, **kwargs):
    ...
    ckpt_path = kwargs.get("ckpt_path", "/home/heydari/paper/12-supp/code/models/yolob6s_ckpt.pt")
...
def _ensure_yolov6_on_path():
    # Checkpoint unpickling needs `import yolov6` to succeed.
    # This file is /home/heydari/paper/12-supp/code/models/yolov6.py -> repo root is parents[3] = /home/heydari/paper
    repo_root = Path(__file__).resolve().parents[3]
    if (repo_root / "yolov6").is_dir():
